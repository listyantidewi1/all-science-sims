...
export const SIMS = [
  projectileMotion, pendulum, wavesOnString, electricField, newtonsCradle, lenses, springsShm, doublePendulum, doppler, diffraction,
  phIndicator, periodicTable, gasLaws, titration, bohrAtom, leChatelier, solubility, vsepr, phaseDiagram, beerLambert,
  punnett, cellExplorer, naturalSelection, dnaTranscription, ecosystem, enzymeActivity, osmosis, hardyWeinberg, actionPotential, pedigree,
  solarSystem, seasons, plateTectonics, moonPhases, greenhouse, eclipses, tides, coriolis, hrDiagram, mantleConvection,
  sortingViz, bst, pathfinding, logicGates, gameOfLife, fractals, caesarCipher, turingMachine, boids, elementaryCA,
  linearReg, distributions, kMeans, clt, bayes, confusionMatrix, outliers, anscombe, monteCarloPi, simpsons,
  supplyDemand, prisonersDilemma, populationDynamics, schelling, sirEpidemic, votingMethods, inequality, preferentialAtt, publicGoods, hawksDoves,
];
